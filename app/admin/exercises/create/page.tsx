...
export default function CreateExercise() {
  ...
  const [correctMatches, setCorrectMatches] = useState(["X", "X", "X", "X", "X"])
      ...
      const newExercise = {
        ...
        ...(exerciseType === "reading" && {
          texts: texts.map((text) => ({
            ...
            correctTitle: text.correctTitle,
          })),
          titles: titles,
        }),
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={exercisePart} onValueChange={setExercisePart} required>
